...
class plot_data_general:
    def __init__(self, np_array_1 = None, np_array_2 = None, np_array_3 = None , savefile_name  = None , labels = None , axis_label = None, limits = None):
        ...
        ax_cf[0][0].set_xlim([x_min,x_max])
        ax_cf[0][0].set_ylim([y_min, y_max])
